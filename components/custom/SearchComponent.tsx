		...
		<Dialog>
			<DialogTrigger asChild>
				<div className="rounded-full py-2 px-5 border flex items-center cursor-pointer">
					...
					<Search className="bg-primary text-white p-1 rounded-full h-8 w-8" />
				</div>
			</DialogTrigger>
					...
					{step === 1 ? (
						<>
							<DialogHeader>
								...
								<DialogDescription>Please Choose a Country, so that what you are looking for</DialogDescription>
							</DialogHeader>
							...
							<MapShowcase locationValue={locationValue} />
						</>
					) : (
						<>
							<DialogHeader>
